...
namespace TrungTam.Areas.Admin.Controllers
{
    public class LOP_HOCController : Controller
    {
        ...
        //{
        //    var malop = Request.QueryString["id"];
        //    var chitiet = (from l in db.LOP_HOC
        //                   join tkb in db.THOI_KHOA_BIEU
        //                   on l.MA_LOP equals tkb.MA_LOP
        //                   join ct_lop in db.CT_LOP_HOC
        //                   on l.MA_LOP equals ct_lop.MA_LOP
        //                   join hs in db.HOC_SINH
        //                   on ct_lop.MA_HS equals hs.MA_HS
        //                   where l.MA_LOP == Guid.Parse(malop)
        //                   select new Details_Class
        //                   {
        //                       tenlop = l.TEN_LOP,
        //                       thu = tkb.THU,
        //                       tgbd = tkb.THOI_GIAN_BD.ToString(),
        //                       Tgkt = tkb.THOI_GIAN_KT.ToString(),
        //                       Mahs = hs.MA_HS,
        //                       Tenhs = hs.HO_TEN,
        //                       Ngaysinh = hs.NG_SINH
